...
declare global {
    ...
    interface Array<T> {
        ...
        at: (index: number) => T;
        firstOrDefault: (key?: keyof T) => T | undefined;
        lastOrDefault: (key?: keyof T) => T | undefined;
        clear: () => T[];
...
Array.prototype.lastOrDefault = function (key?: string) {
...
Array.prototype.firstOrDefault = function (key?: string) {
    let item = undefined;
...
Array.prototype.distinct = function (key: string, itemsB: any[]) {
    let items = this;
    if (itemsB)
...
Array.prototype.niceJson = function (...keyToRemove: string[]) {
